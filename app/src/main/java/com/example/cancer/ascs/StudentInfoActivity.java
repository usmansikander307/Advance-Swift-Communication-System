...
public class StudentInfoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportFragmentManager().beginTransaction().add(R.id.fragmentMain, teacherStatusFragment).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.teacher_status) {
            startActivity(new Intent(StudentInfoActivity.this, TeacherStatusActivity.class));
           // finish();
            ...
            Intent intend = new Intent(StudentInfoActivity.this,Student_Login.class);
