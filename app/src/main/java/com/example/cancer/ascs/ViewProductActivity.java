...
public class ViewProductActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void makeJsonObjectRequest() {
                            ...
                            if (success == 1){
                                ...
                                for(int i =0; i<students.length(); i++){
                                 ...
                                 String pass = phone.get("pass").toString();
                                   String arid = phone.get("arid").toString();
                                ...
                                Toast.makeText(ViewProductActivity.this, "No students in the database", Toast.LENGTH_LONG).show();
                            }
        ...
        AppController.getInstance(ViewProductActivity.this).addToRequestQueue(jsonObjReq);
    }
