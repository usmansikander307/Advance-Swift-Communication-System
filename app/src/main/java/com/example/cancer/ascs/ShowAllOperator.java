...
public class ShowAllOperator extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    private static String TAG = ViewProductActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_all_operator);
    ...
    private void makeJsonObjectRequest() {
                        ...
                        try {
                            ...
                            if (success == 1){
                                ...
                                for(int i =0; i<students.length(); i++){
                                    ...
                                    String cont = phone.get("pass").toString();
                                    String pass = phone.get("cont").toString();
                                ...
                                Toast.makeText(ShowAllOperator.this, "No operators in the database", Toast.LENGTH_LONG).show();
                            }
        ...
        AppController.getInstance(ShowAllOperator.this).addToRequestQueue(jsonObjReq);
    }
