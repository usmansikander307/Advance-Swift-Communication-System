...
public class TeacherActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.screenarea,teacherHomeFragment).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.teacher_st) {
            fragment=new TeacherUpdateFragment();
            // Handle the camera action
        } else if (id == R.id.teacher_attendance) {

            fragment = new MarkAttendaceFragment();
            ...
            fragment=new StudentViewNotificationFragment();
                ...
                Intent intend = new Intent(TeacherActivity.this,Teacher_Login.class);
